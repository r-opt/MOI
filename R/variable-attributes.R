...
#' @export
variable_name <- new("MOI_variable_name_attribute")

#' @export
variable_primal_start <- new("MOI_variable_primal_start_attribute")

#' @export
variable_primal <- new("MOI_variable_primal_attribute")

#' @export
variable_dual <- new("MOI_variable_dual_attribute")

#' @export
variable_index <- function(index) {
